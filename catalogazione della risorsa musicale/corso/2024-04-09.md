...
Esempio: _prima rappresentazione: Parigi teatro italiano 1893 in occasione del battesimo di …_
- dati di rappresentazione:
...
Titolo dell'opera: lv di idea di un contenuto intellettuale, artistico
- per identificare
    + una composizione
    + o una sua parte
...
Estratto: di un'opera più ampia
- esempi:
    + movimento
    + aria
    + …
